...
@pytest.mark.asyncio
async def test_filter_tools_fallback_when_cache_empty(mock_bridge):
    """With None cache and disconnected bridge, _apply_gating is used (no TCP)."""
    from unittest.mock import Mock
    import unity_mcp.server as srv
