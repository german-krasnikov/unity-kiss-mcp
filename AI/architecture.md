...
- **Chat Module** (85+ files, optional behind UNITY_MCP_CHAT define):
  - **Backends:** CliBackendBase, ClaudeBackend, CodexAppServerBackend, CodexAppServerParser, CodexArgBuilder, BackendRegistry, BackendConfig, BackendConfigStore, BackendSettingsForm
